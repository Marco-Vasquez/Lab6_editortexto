...
public class VentanaEditor extends JFrame {
    ...
    private void refrescarBarra() {
        ...
        try {
            ...
            comboTamano.setSelectedItem(estilo.getTamano());
    ...
    private void nuevoDocumento() {
        ...
        areaEditor.setText("");
        areaEditor.setCharacterAttributes(
                servicioDocx.estiloAAtributos(EstiloTexto.porDefecto()), true);
        archivoActual = null;
        actualizarTitulo();
    ...
    private void guardarEnRuta(File archivo) {
        try {
            servicioDocx.guardarDocx(areaEditor, archivo);
            archivoActual = archivo;
            actualizarTitulo();
